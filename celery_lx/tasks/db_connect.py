...
oracle_con_string = celeryconfig.ORACLE_LJ
...
sql_con_string = celeryconfig.SQL_LJ
...
def con_sql():
    ...
    if connect_sql:
        ...
        connect_sql = pymssql.connect(sql_lj['server'], sql_lj["user"], sql_lj["password"], sql_lj["database"])
        return connect_sql
